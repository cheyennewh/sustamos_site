...
<ul>
  <li><b>Experiment Info</b>: Contains information about the experiments conducted within this project. This includes task design and participant recruitment information. </li>
  <li><b>Whole-data analyses</b>: Contains analyses of data from the entire sample of collected participants. Two subsections are contained within this section: the 'VAMOS Data' and 'sustamos data' versions. See subsection headings for more detail on the difference between these two analysis methods. /li>
