...
sust <- rbind( sust1, sust2, sust3, sust4, sust5,sust6,sust7,sust8,sust9,sust10)
memory <- rbind(mem1,mem2,mem3,mem4,mem5,mem6,mem7,mem8,mem9,mem10)
emo <- rbind(emo1,emo2,emo3,emo4,emo5,emo6,emo7,emo8,emo9,emo10)
...
t.test(laps_tot$Correct,laps_tot$Lapse)
...
ggplot(memory_rt, aes(x=as.character(`Participant Private ID`),y=`Reaction Time`,fill=as.character(`Spreadsheet: img`)))+
