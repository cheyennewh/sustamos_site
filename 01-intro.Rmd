...
Below, I have run some of the major interactive regressions with individual ratings of valence and arousal to see how results compare to the models run with VAMOS ratings of valence and arousal.
...
First, I ran a set interactive models with valence, arousal, memorability, pretrial reaction time as predictors of individual memory. For this set of models, individual ratings of valence and arousal were used as the 'Valence' and 'Arousal' terms in the model and were z-scored within each individual.
<details>
...
Then, I ran a similar set of models using averaged participant ratings of valence from the 'classic' experiment as measures of valence and arousal. In this version, each image has a single valence/arousal score which is the mean of all ratings for that image.  The affective score was then z-scored within-group for the two experimental conditions.
<details>
