...
<br>
$\text{hits} \sim \text{Memorability} \cdot \text{Arousal} \cdot \text{Valence} \cdot \text{Reaction Time}+ \\(1 \text{ + Reaction Time+Valence+Arousal+Memorability}\ \\\mid \text{Participant}), \text{family=binomial}$.
