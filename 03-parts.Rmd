...
sust <- rbind(delay_sust1,delay_sust2,delay_sust3,delay_sust4,delay_sust5,delay_sust6)
memory <- rbind(delay_mem1,delay_mem2,delay_mem_early2,delay_mem3,delay_mem4,delay_mem5,delay_mem6)
emo <- rbind(delay_emo1,delay_emo2,delay_emo3,delay_emo4,delay_emo5,delay_emo6,delay_emo_early2)
...
sust_full_rt <-sust_full_rt %>%
  ...
  filter(`Participant Private ID` !="11638956" & `Participant Private ID` !="11658165" & `Participant Private ID` !="11682062"& `Participant Private ID` !="11638973" & `Participant Private ID` !="11682065" )
